...
export const data = [
  {
    src: vid1,
    className: "relative w-full overflow-hidden rounded-[1.2rem] md:w-[calc(66.6666%-1rem)]",
    title: "Design",
    tags: ["First", "Second", "Third", "Fourth"],
  },
  {
    src: vid2,
    className: "relative w-full overflow-hidden rounded-[1.2rem] md:w-[calc(33.3333%-1rem)]",
    title: "Photography",
    tags: ["First", "Second", "Third", "Fourth"],
  },
  {
